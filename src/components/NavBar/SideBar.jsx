  ...
  return (
    <>
      <button
        ...
        disabled={open}
        onClick={toggle}
        className='flex text-white focus:outline-none m-1.5 rounded px-2 py-2 font-medium'
      >
...
const style = {
  ...
  sidenav: {
    open: 'w-7/12 md:w-60 bg-neutral-900 text-white overflow-x-hidden',
    close: 'w-0 bg-neutral-900 text-white overflow-x-hidden',
